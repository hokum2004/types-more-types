...
Степень проработанности типов зависит от потребностей проекта. Где-то будет удобно переопределить и какие-то математические операторы или ввести функции для манипуляции такими типами, чтобы случайно не перемножить друг на дргу килограммы. В большинстве же случаев, достаточо просто будет определить новый тип и в случе каких-то манипуляций извлекать из него базовое значение. А бывает, что и вовсе нет нужды что-то делать кроме как писать/читать в/из хранилища данных.
